@component('layouts.admin')
    ...
    <div class="row">
        <div class="col-sm-12">
            <a href="{{ route('admin.campeonato.create') }}" class="btn btn-secondary btn-admin" title="Novo">
                    ...
                    <tbody>
                        @foreach($campeonatos as $key => $campeonato)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.campeonato.show', $campeonato->id) }}" class="btn btn-secondary" title="Visualizar">
                                        <i class="glyphicon glyphicon-eye-open"></i>
                                    </a>
                                    <a href="{{ route('admin.campeonato.edit', $campeonato->id) }}" class="btn btn-secondary" title="Editar">
