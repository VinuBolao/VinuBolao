    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-slate-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-3 sm:p-6 bg-white dark:bg-slate-800 dark:text-slate-300 border-b last:border-b-0 border-gray-200">
                    ...
                    @foreach ($campeonatos as $key => $campeonato)
                        <div class="flex flex-col md:flex-row border-b-2 last:border-b-0 py-4">
