...
Route::namespace('API\\')->group(function (){
    Route::group(['prefix' => 'bolao'], function (){
        Route::get('get/{id?}', 'BolaoController@get')->where('id', '[0-9]+');
        Route::get('getActive', 'BolaoController@getActive');
    });
    ...
    Route::group(['prefix' => 'palpite'], function (){
        ...
        Route::get('compararPalpites/{jogoId}', 'PalpiteController@getCompararPalpites');
